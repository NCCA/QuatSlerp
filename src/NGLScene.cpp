...
void NGLScene::paintGL()
{
  ...
  auto sx = ngl::Mat4::rotateX(m_srotation.m_x);
  auto sy = ngl::Mat4::rotateY(m_srotation.m_y);
  auto sz = ngl::Mat4::rotateZ(m_srotation.m_z);
  // start=sx*sy*sz;
  //  same for the end rotation
  auto ex = ngl::Mat4::rotateX(m_erotation.m_x);
  auto ey = ngl::Mat4::rotateY(m_erotation.m_y);
  auto ez = ngl::Mat4::rotateZ(m_erotation.m_z);
  end = ez * ey * ex;
